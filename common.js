var common = { 
     ...
     * @returns {*}
     */
    "fun_IsBlank":function(a){
        if(fun_IsUndefined(a)){//未定义
            return true;
     ...
     * @returns {*}
     */
    "fun_getLocalstorage":function(parms){
     ...
     * @param data 数据
     */
    "fun_setLocalstorage":function(parms,data){
     ...
     * @param parms localStorage key名
     */
    "fun_removeLocalstorage":function(parms){
